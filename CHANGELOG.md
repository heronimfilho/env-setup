...
- pinned GitHub Actions, PSScriptAnalyzer, ShellCheck, Markdownlint, Actionlint, JSON Schema validation, and secret-format scanning.

### Changed

- bootstrap can safely update an existing non-Git installation with rollback while preserving custom profiles;
- Git clones update through a clean `main` fast-forward;
